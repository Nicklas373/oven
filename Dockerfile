...
# AOSP Clang 12.0.3
RUN git clone https://github.com/Nicklas373/aosp-clang -b r412851 --depth=1 /root/aosp-clang

# SDCLANG 10.0.9
RUN git clone https://github.com/ThankYouMario/proprietary_vendor_qcom_sdclang -b ruby-10 --depth=1 /root/sdclang-10

# SDCLANG 12.1.1
RUN git clone https://github.com/ThankYouMario/proprietary_vendor_qcom_sdclang -b ruby-12 --depth=1 /root/sdclang-12
